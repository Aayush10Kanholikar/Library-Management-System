...
public class AddNewBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Edition", "1", "2", "3", "4" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "insert into books (book_ID,bookname, publisher, edition, author) values (?, ?, ?, ?, ?)";
        try{
